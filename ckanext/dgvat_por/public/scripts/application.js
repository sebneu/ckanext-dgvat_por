...
CKAN.View.Resource = Backbone.View.extend({
  ...
  render: function() {
    ...
    this.table.find('.js-datastore-disabled-checkbox').change(this.onDatastoreEnabledChange);
    ...
    if (resource_object.resource.webstore_url) {
      this.table.find('.js-datastore-disabled-checkbox').prop('checked', false);
    }
...
CKAN.Utils = function($, my) {
  ...
  my.relatedSetup = function(form) {
    ...
    $(form).submit(function (event) {
      ...
      if (!data.title) {
        addAlert('<strong>Fehlender Eintrag:</strong> Bitte geben Sie einen Titel ein');
        $('[name=title]').parent().addClass('error');
        return;
      }
      if (!data.url) {
        addAlert('<strong>Fehlender Eintrag:</strong> Bitte geben Sie eine URL an');
        $('[name=url]').parent().addClass('error');
        return;
      }
//      if (!data.notes) {
//          addAlert('<strong>Fehlender Eintrag:</strong> Bitte geben Sie eine Beschreibung ein');
//          $('[name=notes]').parent().addClass('error');
//          return;
//      }
//      if (!data.categorization) {
//          addAlert('<strong>Fehlender Eintrag:</strong> Bitte wählen Sie zumindestens eine Kategorie aus');
//          $('[name=categorization]').parent().addClass('error');
//          return;
//      }      
//      if (!data.tag_string) {
//          addAlert('<strong>Fehlender Eintrag:</strong> Bitte geben Sie wenigstens ein Schlagwort ein');
//          $('[name=tag_string]').parent().addClass('error');
//          return;
//      }    
//      if (!data.maintainer) {
//          addAlert('<strong>Fehlender Eintrag:</strong> Bitte geben Sie die datenverantwortliche Stelle an');
//          $('[name=maintainer]').parent().addClass('error');
//          return;
//      }    
//      if (!data.license_id) {
//          addAlert('<strong>Fehlender Eintrag:</strong> Bitte wählen Sie eine Lizenz aus');
//          $('[name=license_id]').parent().addClass('error');
//          return;
//      }   
//      if (!data.begin_datetime) {
//          addAlert('<strong>Fehlender Eintrag:</strong> Bitte geben Sie den Beginn der zeitlichen Ausdehnung an');
//          $('[name=begin_datetime]').parent().addClass('error');
//          return;
//      }        
